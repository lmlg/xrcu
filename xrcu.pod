...
a special I<sentinel> value, that is temporarily set when a swap is undergoing.
During a swap, C<push> and C<pop> cannot proceed, since they check against that
special value before modifying the stack.
